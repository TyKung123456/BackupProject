...
session_start();
 ...
 $sql = 'SELECT * FROM `scoreboard` WHERE `users_uid`= '.$_SESSION["userid"].' AND `game_name` = "PYTHON"';
...
<body>
    ...
    <div class="question-container" id="question-container">
        <p class="question-container-question"> PYTHON ★ </p>
    </div>
    ...
    <!-- partial -->
    <script src="./lang_python.js"></script>
