...
session_start();
 ...
 $sql = 'SELECT * FROM `scoreboard` WHERE `users_uid`= '.$_SESSION["userid"].' AND `game_name` = "JAVASCRIPT"';
...
<body>
    ...
    <div class="question-container" id="question-container">
        <p class="question-container-question"> JAVASCRIPT ★ </p>
    </div>
